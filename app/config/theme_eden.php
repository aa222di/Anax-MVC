...
return [
     ...
     */
    'views' => [
        ['region' => 'header', 'template' => 'eden/header', 'data' =>  
                    [
                    'siteTitle' => "Eden Theme",
                    'siteSlogan' => "A theme for Anax-MVC",
                    ], 
                    'sort' => -1],
    ...
    'data' => [
        ...
        'title_append' => ' | Eden Theme',

        // Stylesheets
        'stylesheets' => ['css/eden/style.php'],
        ...
        'javascript_include' => ['js/enquire.min.js'],
